...
public class CommandBuilderTests
{
    ...
    public void ItShouldAddOptionalArgument1()
    {
        // Arrange
        var builder = new CommandBuilder(null);
        builder.AddOptionalArgument(new ArgumentKeys("test", "test"), "test", _ => ValidationResult.OkAsync());
    ...
    public void ItShouldAddOptionalArgument2()
    {
        // Arrange
        var builder = new CommandBuilder(null);
        builder.AddOptionalArgument("test", "test", "test", _ => ValidationResult.OkAsync());
    ...
    public void ItShouldAddOptionalArgument3()
    {
        // Arrange
        var builder = new CommandBuilder(null);
        builder.AddOptionalArgument("test", "test", _ => ValidationResult.OkAsync());
    ...
    public void ItShouldAddArgument1()
    {
        // Arrange
        var builder = new CommandBuilder(null);
        builder.AddArgument(new ArgumentKeys("test", "test"), "test", true, _ => ValidationResult.OkAsync());
    ...
    public void ItShouldAddArgument2()
    {
        // Arrange
        var builder = new CommandBuilder(null);
        builder.AddArgument("test", "test", "test", true, _ => ValidationResult.OkAsync());
